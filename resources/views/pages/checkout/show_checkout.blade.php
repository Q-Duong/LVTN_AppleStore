            ...
            <div class="col-lg-4">
                ...
                <div class="cart__discount">
                    ...
                    <form method="POST" action="{{url('/check-coupon')}}" class="couponform">
                        {{csrf_field()}}
                        <input type="text" class="coupon-input" name="coupon" placeholder="Nhập mã giảm giá" data-validation="required" data-validation-error-msg="Vui Lòng điền thông tin">
...
<section class="checkout spad">
    <div class="container">
        <div class="checkout__form">
            <form method="POST" onsubmit="required()" name="form_Confirm">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="checkout__input {{ $errors->has('shipping_first_name') ? 'has-error' : ''}}">
                                    <p>Họ và tên lót<span>*</span></p>
                                    <input type="text" name="shipping_first_name" class="shipping_first_name"
                                        ...
                                        {!! $errors->first('shipping_first_name', '<div class="alert-error"><i class="fa fa-exclamation-circle"></i> :message</div>') !!}
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="checkout__input {{ $errors->has('shipping_last_name') ? 'has-error' : ''}}">
                                    <p>Tên<span>*</span></p>
                                    <input type="text" name="shipping_last_name" class="shipping_last_name"
                                        placeholder="Điền họ và tên" value="{{Session::get('customer_last_name')}}"
                                        data-validation="required" data-validation-error-msg="Vui Lòng điền thông tin">
                                        {!! $errors->first('shipping_last_name', '<div class="alert-error"><i class="fa fa-exclamation-circle"></i> :message</div>') !!}
                                </div>
                            </div>
                        </div>
                        <div class="checkout__input {{ $errors->has('shipping_phone') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="shipping_phone" class="shipping_phone"
                                ...
                                {!! $errors->first('shipping_phone', '<div class="alert-error"><i class="fa fa-exclamation-circle"></i> :message</div>') !!}
                        </div>
                        <div class="checkout__input {{ $errors->has('shipping_email') ? 'has-error' : ''}}">
                            <p>Email<span>*</span></p>
                            <input type="email" name="shipping_email" class="shipping_email"
                                ...
                                {!! $errors->first('shipping_email', '<div class="alert-error"><i class="fa fa-exclamation-circle"></i> :message</div>') !!}
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="checkout__input {{ $errors->has('shipping_address') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="shipping_address" class="shipping_address"
                                        ...
                                        {!! $errors->first('shipping_address', '<div class="alert-error"><i class="fa fa-exclamation-circle"></i> :message</div>') !!}
                                </div>
                            </div>
                        </div>
