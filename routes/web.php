...
Route::get('/login-customer-google','App\Http\Controllers\CustomerController@login_customer_google');
Route::get('/customer/google/callback','App\Http\Controllers\CustomerController@callback_customer_google');
